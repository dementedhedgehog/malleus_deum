...
class LatexFormatter:
    ...
    def start_book(self, book):
        ...
        self.latex_file.write(
            ...
            ""
            "\\newcommand{\\facircleo}\n"
            "  {\\begingroup\\fontawesome\\scriptsize\\selectfont\\char\"F10C\\endgroup}\n"
            "\\newcommand{\\facircle}\n"
            "  {\\begingroup\\fontawesome\\scriptsize\\selectfont\\char\"F111\\endgroup}\n"
            "\\newcommand{\\fatick}\n"  
            " {\\begingroup\\fontawesome\\scriptsize\\selectfont\\symbol{\"F05D}\\endgroup}\n"
            "\\newcommand{\\faquestion}\n"  
            " {\\begingroup\\fontawesome\\scriptsize\\selectfont\\symbol{\"F29C}\\endgroup}\n"
            "\\newcommand{\\facross}\n"  
            " {\\begingroup\\fontawesome\\scriptsize\\selectfont\\symbol{\"F05C}\\endgroup}\n"
            "\\newcommand{\\fastar}\n"  
            " {\\begingroup\\fontawesome\\scriptsize\\selectfont\\symbol{\"F005}\\endgroup}\n"
            "\\newcommand{\\fastaro}\n"   
           ...
           "\\newcommand{\\theurgical}{"
            "\\begingroup\\fontawesome\\small\\selectfont\\symbol{\"F24E}\\endgroup}\n"
            "\\newcommand{\\magical}{"
           "\\begingroup\\fontawesome\\small\\selectfont\\hspace{0.5mm}\\symbol{\"F0E7}\\hspace{0.08em}\\endgroup}\n"
            "\n"
