...
SKILL_POSITION_LOOKUP = {
    ...
    "gun.maintenance": (Page.ONE, "gun.shoot", ((40, -10),)),
    "gun.shoot": (Page.ONE, "school.military", ((30, -50),)),
    "gun.sharp_shooter": (Page.ONE, "gun.shoot", ((30, 10),)),
    ...
    "lore.grand_discovery": (Page.TWO, "lore.alchemy", ((10, 50),)),
    ...
    "luck.brilliant_planner": (Page.ONE, "luck.lucky", ((140, 30),)),
    ...
    "magic.therianthropy": (Page.TWO, "magic_school.wild_magic", ((40, 10),)),
    ...
    "monster.horns_lesser": (Page.NONE, None, ((100, 123),)),
    "monster.horns": (Page.NONE, None, ((100, 100),)),
    "monster.horns_greater": (Page.NONE, None, ((100, 100),)),
    "monster.prehensile_tongue": (Page.NONE, None, ((100, 100),)),
    "monster.prehensile_tail": (Page.NONE, None, ((100, 130),)),
    "monster.regeneration": (Page.NONE, None, ((140, 100),)),
    ...
    "physical.juggernaut": (Page.ONE, "school.physical", ((95, 5),)),
    ...
    "physical.sure_feet": (Page.ONE, "school.physical", ((0, -90),)),
